<?php
	...
	if($mega_construction_first_theme_color != false){
		$mega_construction_custom_css .='a.button, #comments a.comment-reply-link:hover, #sidebar .tagcloud a:hover, span.page-number,span.page-links-title, #contact-us, h1.page-title, h1.search-title , .textbox, .blogbtn a, .woocommerce span.onsale, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button,.woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, nav.woocommerce-MyAccount-navigation ul li, .bradcrumbs a, #sidebar h3::before, #wrapper h1, .pagination .current, span.meta-nav , .title-box, input[type="submit"]:hover, .nav-menu ul ul li a:hover, .tags a:hover, .woocommerce .widget_price_filter .price_slider_wrapper .ui-widget-content{';
